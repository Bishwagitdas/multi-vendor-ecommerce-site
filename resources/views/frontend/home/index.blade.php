...
@include('frontend.home.home_slider_banner')
<!--End hero slider-->
@include('frontend.home.home_featured_categories_slider')
<!--End category slider-->
@include('frontend.home.home_static_banner')
<!--End banners-->
...
@include('frontend.home.home_all_vendor_list')
