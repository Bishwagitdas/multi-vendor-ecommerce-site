        ...
        <p class="msg-info">Your new product has approved</p>
            ...
            <div class="user-box dropdown">
                <a class="d-flex align-items-center nav-link dropdown-toggle dropdown-toggle-nocaret" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                    <img src="{{ (!empty(Auth::user()->photo))? url('upload/vendor_images/'.Auth::user()->photo):url('backend/assets/images/default_user.jpg') }}" class="user-img" alt="user avatar">
                    <div class="user-info ps-3">
                        <p class="user-name mb-0">{{'Hi, '.Auth::user()->name}}</p>
                        <p class="designattion mb-0">Logged as Vendor</p>
                    </div>
                </a>
                <ul class="dropdown-menu dropdown-menu-end">
                    <li><a class="dropdown-item" href="{{route('vendor.profile')}}"><i class="bx bx-user"></i><span>Profile</span></a>
                    </li>
                    <li><a class="dropdown-item" href="{{route('vendor.password')}}"><i class="bx bx-key"></i><span>Change Password</span></a>
                    </li>
